...
export class CraftSimulator {
    ...
    free() {
        ...
        wasm.__wbg_craftsimulator_free(ptr);
    }
    /**
    * @param {any} synth
    ...
    */
    static new_wasm(synth) {
        try {
            const ret = wasm.craftsimulator_new_wasm(addBorrowedObject(synth));
    ...
    */
    next_wasm() {
        const ret = wasm.craftsimulator_next_wasm(this.ptr);
    ...
    */
    pause_wasm() {
        const ret = wasm.craftsimulator_pause_wasm(this.ptr);
        return takeObject(ret);
    }
}
...
function getImports() {
    ...
    imports.wbg.__wbg_log_6e9872b7bea3d581 = function(arg0, arg1) {
