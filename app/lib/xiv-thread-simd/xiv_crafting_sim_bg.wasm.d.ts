/* tslint:disable */
/* eslint-disable */
export function __wbg_craftsimulator_free(a: number): void;
export function craftsimulator_new_wasm(a: number): number;
export function craftsimulator_next_wasm(a: number): number;
export function craftsimulator_pause_wasm(a: number): number;
